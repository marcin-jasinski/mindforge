...
public class AIGatewayAdapter implements AIGateway, DisposableBean {
    ...
    public AIGatewayAdapter(ChatModel chatModel, EmbeddingModel embeddingModel, AppProperties properties) {
    ...
    private ChatResponse callWithDeadline(Prompt request, DeadlineProfile deadline) {
        ...
        Future<ChatResponse> future = deadlineExecutor.submit(() -> chatModel.call(request));
        try {
            ...
            throw new IllegalStateException("AI gateway call failed", e.getCause());
        }
    }
