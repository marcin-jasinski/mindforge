...
Instructs the vision model to describe images and diagrams in an educational
context, producing text that can be injected into downstream summarisation and
